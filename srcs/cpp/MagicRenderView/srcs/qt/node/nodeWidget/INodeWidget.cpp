...
void INodeWidget::emplace_back_ID( INodeComponent *emplace_ptr, size_t &id ) {
	emplace_ptr->setParentNodeWidget( this );
	componentID.emplace_back( emplace_ptr, id );
	connect( emplace_ptr, &INodeComponent::thisDelete, [this] ( INodeComponent *component ) {
