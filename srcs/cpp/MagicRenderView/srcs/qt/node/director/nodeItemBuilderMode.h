...
public:
	...
	/// @return 模块列表指针对象
	static std_vector_shared_unity_shared< NodeItemBuilderMode > generateNodeItemBuilderModeVector( const std_vector< NodeItemInfo * > &start_node_item_info_vector, const std_vector< NodeItemInfo * > &normal_node_item_info_vector );
	/// @brief 生成运行模块
