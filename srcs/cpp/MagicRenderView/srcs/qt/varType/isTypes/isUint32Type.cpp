...
IsUint32Type::IsUint32Type( ): I_IsType( typeid( t_current_type ) ) { }
...
bool IsUint32Type::getCheckTypeNames( const type_info &check_type_info, const uint8_t *check_type_data_ptr, const size_t &check_type_data_count, std_vector<QString> &result_alias_name_list ) const {
