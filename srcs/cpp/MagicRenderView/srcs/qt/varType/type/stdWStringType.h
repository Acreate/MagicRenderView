#ifndef STDWSTRINGTYPE_H_H_HEAD__FILE__
#define STDWSTRINGTYPE_H_H_HEAD__FILE__
#pragma once


#include "../I_Stack.h"
class StdWStringType : public  I_Stack{
	using t_current_type = std::wstring;
public:
	StdWStringType( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // STDWSTRINGTYPE_H_H_HEAD__FILE__
