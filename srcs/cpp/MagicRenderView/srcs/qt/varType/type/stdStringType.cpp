...
bool StdStringType::createTarget( const type_info &target_type_info, void *&target_ptr ) {
...
bool StdStringType::toOBjVector( const type_info &target_type_info, void *&target_ptr, size_t &result_count, const std_vector<uint8_t> &load_bin_vector ) {
