#ifndef INT16TYPE_H_H_HEAD__FILE__
#define INT16TYPE_H_H_HEAD__FILE__
#pragma once
...
class Int16Type: public  I_Stack{
	using t_current_type = int16_t;
public:
	Int16Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // INT16TYPE_H_H_HEAD__FILE__
