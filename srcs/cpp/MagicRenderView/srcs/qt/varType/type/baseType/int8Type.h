#ifndef INT8TYPE_H_H_HEAD__FILE__
#define INT8TYPE_H_H_HEAD__FILE__
#pragma once

#include "../../I_Stack.h"
class Int8Type : public I_Stack {
	using t_current_type = int8_t;
public:
	Int8Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // INT8TYPE_H_H_HEAD__FILE__
