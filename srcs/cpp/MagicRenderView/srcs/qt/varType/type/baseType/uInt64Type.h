#ifndef UINT64TYPE_H_H_HEAD__FILE__
#define UINT64TYPE_H_H_HEAD__FILE__
#pragma once
...
class UInt64Type : public I_Stack {
	using t_current_type = uint64_t;
public:
	UInt64Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // UINT64TYPE_H_H_HEAD__FILE__
