#ifndef FLOAT64TYPE_H_H_HEAD__FILE__
#define FLOAT64TYPE_H_H_HEAD__FILE__
#pragma once

#include "../../I_Stack.h"
class Float64Type : public I_Stack {
	using t_current_type = double;
public:
	Float64Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // FLOAT64TYPE_H_H_HEAD__FILE__
