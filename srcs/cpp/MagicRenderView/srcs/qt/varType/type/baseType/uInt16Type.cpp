...
UInt16Type::UInt16Type( ) : I_Stack( typeid( t_current_type ) ) {
	childcreateFunction = [] {
...
bool UInt16Type::toBinVector( const type_info &target_type_info, const void *target_ptr, std_vector< uint8_t > &result_vector, size_t &result_count ) const {
