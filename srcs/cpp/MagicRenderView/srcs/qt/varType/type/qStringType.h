#ifndef QSTRINGTYPE_H_H_HEAD__FILE__
#define QSTRINGTYPE_H_H_HEAD__FILE__
#pragma once


#include "../I_Stack.h"
class QStringType : public  I_Stack{
	using t_current_type = QString;
public:
	QStringType( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // QSTRINGTYPE_H_H_HEAD__FILE__
