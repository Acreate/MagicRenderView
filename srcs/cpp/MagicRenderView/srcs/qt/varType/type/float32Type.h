#ifndef FLOAT32TYPE_H_H_HEAD__FILE__
#define FLOAT32TYPE_H_H_HEAD__FILE__
#pragma once

#include "../I_Stack.h"

class Float32Type : public  I_Stack{
	using t_current_type = float;
public:
	Float32Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // FLOAT32TYPE_H_H_HEAD__FILE__
