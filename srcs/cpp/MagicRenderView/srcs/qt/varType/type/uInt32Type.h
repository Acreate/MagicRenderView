#ifndef UINT32TYPE_H_H_HEAD__FILE__
#define UINT32TYPE_H_H_HEAD__FILE__
#pragma once

#include "../I_Stack.h"
class UInt32Type : public I_Stack {
	using t_current_type = uint32_t;
public:
	UInt32Type( ) : I_Stack( typeid( t_current_type ) ) { }
...
#endif // UINT32TYPE_H_H_HEAD__FILE__
