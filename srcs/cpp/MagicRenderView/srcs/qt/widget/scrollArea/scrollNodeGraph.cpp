...
size_t ScrollNodeGraph::serializeToObjectData( const uint8_t *read_data_vector, const size_t data_count ) const {
	return nodeGraph->serializeToObjectData( read_data_vector, TODO );
}
