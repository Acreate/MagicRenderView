...
static std_shared_ptr< ITypeObject > add( const IVarStack &var_stack, const IFunctionDeclaration &i_function_declaration ) {
...
CalculateAdd::CalculateAdd( ) : IFunctionDeclaration( "double add(double[] add_var_list)", add ) { }
