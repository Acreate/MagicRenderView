...
namespace ifunction {
	static std_shared_ptr< ITypeObject > floatSub( const IVarStack &global_var_stack, IVarStack &local_var_stack, const IFunctionDeclaration &i_function_declaration ) {
