...
public:
	class Serialization final {
		...
		/// @return 填充个数
		static size_t fillBinVector( const void *source_ptr, const size_t &source_ptr_count, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
		...
		static size_t fillBinVector( const uint8_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof uint8_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const uint16_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof uint16_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const uint32_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof uint32_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const uint64_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof uint64_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const float_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof float_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const double_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( &var_type, sizeof double_t, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const std::string &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			QString fromStdString = QString::fromStdString( var_type );
			return fillBinVector( fromStdString, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const std::wstring &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			QString fromStdString = QString::fromStdWString( var_type );
			return fillBinVector( fromStdString, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const int8_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( ( uint8_t ) var_type, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const int16_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( ( const uint16_t ) var_type, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const int32_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( ( const uint32_t ) var_type, result_mirror_image_bin_vector );
		}
		static size_t fillBinVector( const int64_t &var_type, std_vector< uint8_t > &result_mirror_image_bin_vector ) {
			return fillBinVector( ( const uint64_t ) var_type, result_mirror_image_bin_vector );
		}
		static size_t fillObjVector( QString *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
			size_t count;
		...
		static size_t fillObjVector( uint8_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( uint16_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( uint32_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( uint64_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( float_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( double_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( std::string *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
			QString buff;
		...
		static size_t fillObjVector( std::wstring *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
			QString buff;
			auto count = fillObjVector( &buff, source_ptr, source_ptr_count );
			if( count == 0 )
				return 0;
		...
		static size_t fillObjVector( int8_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( int16_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( int32_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
		...
		static size_t fillObjVector( int64_t *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) {
	...
	public:
		...
		public:
			...
			void init( TClassName &vector ) {
				unityTypeName = typeid( TClassName ).name( );
			}
			template< typename TClassName >
			void initConst( const TClassName &vector ) {
	...
	protected:
		QString typeName;
	public:
		virtual size_t fillBinVector( const Unity *var_type, std_vector< uint8_t > &result_bin_data_vector ) const = 0;
		virtual size_t fillObjVector( Unity *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const = 0;
		virtual size_t fillVectorBinVector( const UnityVector *var_type, std_vector< uint8_t > &result_bin_data_vector ) const = 0;
		virtual size_t fillVectorObjVector( UnityVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const = 0;
		virtual size_t fillPtrVectorBinVector( const UnityPtrVector *var_type, std_vector< uint8_t > &result_bin_data_vector ) const = 0;
		virtual size_t fillPtrVectorObjVector( UnityPtrVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const = 0;
	public:
		BinGenerateItem( ) { }
