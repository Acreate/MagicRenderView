#ifndef INT8SERIALIZATION_H_H_HEAD__FILE__
#define INT8SERIALIZATION_H_H_HEAD__FILE__
#pragma once
#include "../generate/binGenerate.h"

class Int8Serialization : public BinGenerate::BinGenerateItem {

public:
	Int8Serialization( ) {
		typeName = typeid( int8_t ).name( );
	}
...
#endif // INT8SERIALIZATION_H_H_HEAD__FILE__
