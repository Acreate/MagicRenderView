#ifndef FLOAT64SERIALIZATION_H_H_HEAD__FILE__
#define FLOAT64SERIALIZATION_H_H_HEAD__FILE__
#pragma once
#include "../generate/binGenerate.h"

class Float64Serialization : public BinGenerate::BinGenerateItem {

public:
	Float64Serialization( ) {
		typeName = typeid( double_t ).name( );
	}
...
#endif // FLOAT64SERIALIZATION_H_H_HEAD__FILE__
