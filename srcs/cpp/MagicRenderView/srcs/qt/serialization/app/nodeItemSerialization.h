#ifndef NODEITEMSERIALIZATION_H_H_HEAD__FILE__
#define NODEITEMSERIALIZATION_H_H_HEAD__FILE__
#pragma once
#include "../../generate/binGenerate.h"

class NodeItem;
class NodeItemSerialization : public BinGenerate::BinGenerateItem {

	using t_current_type = NodeItem;
public:
	NodeItemSerialization( );
...
#endif // NODEITEMSERIALIZATION_H_H_HEAD__FILE__
