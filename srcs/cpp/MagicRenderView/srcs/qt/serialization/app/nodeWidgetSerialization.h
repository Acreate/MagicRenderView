#ifndef NODEWIDGETSERIALIZATION_H_H_HEAD__FILE__
#define NODEWIDGETSERIALIZATION_H_H_HEAD__FILE__
#pragma once

#include "../../generate/binGenerate.h"

class MainWidget;
class NodeWidgetSerialization : public BinGenerate::BinGenerateItem {

	using t_current_type = MainWidget;
public:
	NodeWidgetSerialization( );
...
#endif // NODEWIDGETSERIALIZATION_H_H_HEAD__FILE__
