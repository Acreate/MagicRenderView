#ifndef INT16SERIALIZATION_H_H_HEAD__FILE__
#define INT16SERIALIZATION_H_H_HEAD__FILE__
#pragma once
#include "../generate/binGenerate.h"

class Int16Serialization : public BinGenerate::BinGenerateItem {

public:
	Int16Serialization( ) {
		typeName = typeid( int16_t ).name( );
	}
...
#endif // INT16SERIALIZATION_H_H_HEAD__FILE__
