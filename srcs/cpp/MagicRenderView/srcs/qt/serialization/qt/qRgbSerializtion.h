#ifndef QRGBSERIALIZTION_H_H_HEAD__FILE__
#define QRGBSERIALIZTION_H_H_HEAD__FILE__
#pragma once

#include "../../generate/binGenerate.h"

class QRgbSerializtion : public BinGenerate::BinGenerateItem {

	using t_current_type = QColor;
public:
	QRgbSerializtion( ) : BinGenerateItem( ) {
...
#endif // QRGBSERIALIZTION_H_H_HEAD__FILE__
