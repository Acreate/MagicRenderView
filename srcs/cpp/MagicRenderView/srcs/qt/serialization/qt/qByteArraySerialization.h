#ifndef QBYTEARRAYSERIALIZTION_H_H_HEAD__FILE__
#define QBYTEARRAYSERIALIZTION_H_H_HEAD__FILE__
#pragma once
#include "../../generate/binGenerate.h"

class QByteArraySerialization : public BinGenerate::BinGenerateItem {

	using t_current_type = QByteArray;
public:
	QByteArraySerialization( );
...
#endif // QBYTEARRAYSERIALIZTION_H_H_HEAD__FILE__
