...
size_t Uint32Serialization::fillObj( Unity *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
...
size_t Uint32Serialization::fillObj( UnityVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
	auto dataPtr = target_var_ptr->get< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
...
size_t Uint32Serialization::fillObj( UnityPtrVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
	auto dataPtr = target_var_ptr->get< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
