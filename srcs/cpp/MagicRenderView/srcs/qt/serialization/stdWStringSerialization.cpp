...
size_t StdWStringSerialization::fillBin( const Unity *var_type, std_vector< uint8_t > &result_bin_data_vector ) const {
...
size_t StdWStringSerialization::fillObj( Unity *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
...
size_t StdWStringSerialization::fillBin( const UnityVector *var_type, std_vector< uint8_t > &result_bin_data_vector ) const {
	auto dataPtr = var_type->getConst< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
...
size_t StdWStringSerialization::fillObj( UnityVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
	auto dataPtr = target_var_ptr->get< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
...
size_t StdWStringSerialization::fillBin( const UnityPtrVector *var_type, std_vector< uint8_t > &result_bin_data_vector ) const {
	auto dataPtr = var_type->getConst< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
...
size_t StdWStringSerialization::fillObj( UnityPtrVector *target_var_ptr, const uint8_t *source_ptr, const size_t &source_ptr_count ) const {
	auto dataPtr = target_var_ptr->get< t_current_type >( );
	if( dataPtr == nullptr )
		return 0;
