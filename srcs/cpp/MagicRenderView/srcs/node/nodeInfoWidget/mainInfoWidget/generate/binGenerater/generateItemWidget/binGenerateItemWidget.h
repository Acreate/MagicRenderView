#ifndef BINGENERATEITEMWIDGET_H_H_HEAD__FILE__
#define BINGENERATEITEMWIDGET_H_H_HEAD__FILE__
...
class QPushButton;
class QLabel;
class BinGenerateItemWidget : public QWidget {
	Q_OBJECT;
public:
	...
	QMenu *popMenu;
public:
	BinGenerateItemWidget( QWidget *parent = nullptr, const Qt::WindowFlags &f = Qt::WindowFlags( ) );
...
Q_SIGNALS:
	...
	void removeVar( BinGenerateItemWidget *signal_ptr );
	/// @brief 点击更改变量发生信号
	/// @param signal_ptr 信号对象指针
	void changeVar( BinGenerateItemWidget *signal_ptr );
	/// @brief 点击还原变量发生信号
	/// @param signal_ptr 信号对象指针
	void restoryVar( BinGenerateItemWidget *signal_ptr );
};
