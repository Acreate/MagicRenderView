#ifndef CHARGENERATEITEMWIDGET_H_H_HEAD__FILE__
#define CHARGENERATEITEMWIDGET_H_H_HEAD__FILE__
...
class QPushButton;
class QLabel;
class CharGenerateItemWidget : public QWidget {
	Q_OBJECT;
public:
	...
	QMenu *popMenu;
public:
	CharGenerateItemWidget( QWidget *parent = nullptr, const Qt::WindowFlags &f = Qt::WindowFlags( ) );
...
Q_SIGNALS:
	...
	void removeVar( CharGenerateItemWidget *signal_ptr );
	/// @brief 点击更改变量发生信号
	/// @param signal_ptr 信号对象指针
	void changeVar( CharGenerateItemWidget *signal_ptr );
	/// @brief 点击还原变量发生信号
	/// @param signal_ptr 信号对象指针
	void restoryVar( CharGenerateItemWidget *signal_ptr );
};
