#include "binGenerateTool.h"

#include <QComboBox>
#include <QVBoxLayout>
#include <QLineEdit>
#include <qpushbutton.h>
BinGenerateTool::BinGenerateTool( QWidget *parent, const Qt::WindowFlags &f ) : QWidget( parent, f ) {
...
void BinGenerateTool::setMaxIndex( const size_t &index ) {
