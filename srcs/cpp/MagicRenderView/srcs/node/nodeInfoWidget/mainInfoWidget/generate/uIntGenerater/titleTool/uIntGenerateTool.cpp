#include "uIntGenerateTool.h"

#include <QComboBox>
#include <QVBoxLayout>
#include <QLineEdit>
#include <qpushbutton.h>
UIntGenerateTool::UIntGenerateTool( QWidget *parent, const Qt::WindowFlags &f ) : QWidget( parent, f ) {
...
void UIntGenerateTool::setMaxIndex( const size_t &index ) {
