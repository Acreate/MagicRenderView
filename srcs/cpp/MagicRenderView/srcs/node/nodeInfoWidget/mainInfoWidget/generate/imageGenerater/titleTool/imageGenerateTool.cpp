#include "imageGenerateTool.h"

#include <QComboBox>
#include <QVBoxLayout>
#include <QLineEdit>
#include <qpushbutton.h>
ImageGenerateTool::ImageGenerateTool( QWidget *parent, const Qt::WindowFlags &f ) : QWidget( parent, f ) {
...
void ImageGenerateTool::setMaxIndex( const size_t &index ) {
