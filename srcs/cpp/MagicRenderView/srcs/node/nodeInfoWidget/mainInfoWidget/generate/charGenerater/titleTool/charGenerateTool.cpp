...
CharGenerateTool::CharGenerateTool( QWidget *parent, const Qt::WindowFlags &f ) : QWidget( parent, f ) {
...
void CharGenerateTool::setMaxIndex( const size_t &index ) {
