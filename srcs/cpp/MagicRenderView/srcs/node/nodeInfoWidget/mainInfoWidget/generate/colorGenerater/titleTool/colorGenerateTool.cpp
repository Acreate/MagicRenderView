#include "colorGenerateTool.h"

#include <QComboBox>
#include <QVBoxLayout>
#include <QLineEdit>
#include <qpushbutton.h>
ColorGenerateTool::ColorGenerateTool( QWidget *parent, const Qt::WindowFlags &f ) : QWidget( parent, f ) {
...
void ColorGenerateTool::setMaxIndex( const size_t &index ) {
