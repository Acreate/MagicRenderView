#ifndef COLORGENERATEITEMWIDGET_H_H_HEAD__FILE__
#define COLORGENERATEITEMWIDGET_H_H_HEAD__FILE__
...
class QPushButton;
class QLabel;
class ColorGenerateItemWidget : public QWidget {
	Q_OBJECT;
public:
	...
	QMenu *popMenu;
public:
	ColorGenerateItemWidget( QWidget *parent = nullptr, const Qt::WindowFlags &f = Qt::WindowFlags( ) );
...
Q_SIGNALS:
	...
	void removeVar( ColorGenerateItemWidget *signal_ptr );
	/// @brief 点击更改变量发生信号
	/// @param signal_ptr 信号对象指针
	void changeVar( ColorGenerateItemWidget *signal_ptr );
	/// @brief 点击还原变量发生信号
	/// @param signal_ptr 信号对象指针
	void restoryVar( ColorGenerateItemWidget *signal_ptr );
};
