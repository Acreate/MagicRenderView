#ifndef IMAGEGENERATEITEMWIDGET_H_H_HEAD__FILE__
#define IMAGEGENERATEITEMWIDGET_H_H_HEAD__FILE__
...
class QPushButton;
class QLabel;
class ImageGenerateItemWidget : public QWidget {
	Q_OBJECT;
public:
	...
	QMenu *popMenu;
public:
	ImageGenerateItemWidget( QWidget *parent = nullptr, const Qt::WindowFlags &f = Qt::WindowFlags( ) );
...
Q_SIGNALS:
	...
	void removeVar( ImageGenerateItemWidget *signal_ptr );
	/// @brief 点击更改变量发生信号
	/// @param signal_ptr 信号对象指针
	void changeVar( ImageGenerateItemWidget *signal_ptr );
	/// @brief 点击还原变量发生信号
	/// @param signal_ptr 信号对象指针
	void restoryVar( ImageGenerateItemWidget *signal_ptr );
};
