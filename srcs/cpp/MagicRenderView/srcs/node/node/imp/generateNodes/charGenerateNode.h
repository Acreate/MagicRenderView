#ifndef CHARGENERATENODE_H_H_HEAD__FILE__
#define CHARGENERATENODE_H_H_HEAD__FILE__
...
class CharGenerateNode : public GenerateNode {
	Q_OBJECT;
private:
	using TGenerateType = QChar;
protected:
...
public:
	CharGenerateNode( const QString &node_name );
...
public:
	Def_Extend_NodeTypeName( Node::tr( "生成/生成字符" ) );
};

#endif // CHARGENERATENODE_H_H_HEAD__FILE__
