...
ColorArrayModNode::ColorArrayModNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool ColorArrayModNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
