...
ImageArrayDivNode::ImageArrayDivNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool ImageArrayDivNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
