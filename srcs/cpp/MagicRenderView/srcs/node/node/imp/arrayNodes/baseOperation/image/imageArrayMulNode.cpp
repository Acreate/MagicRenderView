...
ImageArrayMulNode::ImageArrayMulNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool ImageArrayMulNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
