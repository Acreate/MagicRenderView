...
FloatArrayMulNode::FloatArrayMulNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool FloatArrayMulNode::updateLayout( ) {
	if( ArrayNode::updateLayout( ) == false )
		return false;
	return true;
}
bool FloatArrayMulNode::readyNodeRunData( ) {
