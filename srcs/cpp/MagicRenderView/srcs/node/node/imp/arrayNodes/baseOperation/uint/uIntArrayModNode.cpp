...
UIntArrayModNode::UIntArrayModNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool UIntArrayModNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
