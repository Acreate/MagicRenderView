...
ImageArraySelfAddNode::ImageArraySelfAddNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool ImageArraySelfAddNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
