...
ColorArrayDivNode::ColorArrayDivNode( const QString &node_name ) : ArrayNode( node_name ) {
...
bool ColorArrayDivNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time ) {
