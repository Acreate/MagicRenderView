...
Def_Entity_NodeTypeName_Function( ImageArrayModNode, Node::tr( "图像/序列/求余" ) );

ImageArrayModNode::ImageArrayModNode( const QString &node_name ) : ProcessNode( node_name ) {
...
bool ImageArrayModNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
