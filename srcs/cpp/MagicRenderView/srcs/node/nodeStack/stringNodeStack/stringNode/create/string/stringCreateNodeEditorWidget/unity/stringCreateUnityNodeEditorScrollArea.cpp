...
StringCreateUnityNodeEditorScrollArea::StringCreateUnityNodeEditorScrollArea( NodeInfoWidget *parent, uint8_t current_var ) : EditorNodeInfoScrollArea( parent ), currentVar( current_var ) {
...
void StringCreateUnityNodeEditorScrollArea::setCurrentVar( uint8_t current_var ) {
