...
UintCreateUnityNodeEditorScrollArea::UintCreateUnityNodeEditorScrollArea( NodeInfoWidget *parent, uint8_t current_var ) : EditorNodeInfoScrollArea( parent ), currentVar( current_var ) {
...
void UintCreateUnityNodeEditorScrollArea::setCurrentVar( uint8_t current_var ) {
