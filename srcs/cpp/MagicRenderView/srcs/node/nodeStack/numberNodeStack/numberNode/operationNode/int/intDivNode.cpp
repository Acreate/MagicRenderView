...
Def_Entity_NodeTypeName_Function( IntDivNode, Node::tr( "运算/单元/整数/除法" ) );
...
bool IntDivNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
