...
Def_Entity_NodeTypeName_Function( FloatArraySubNode, Node::tr( "运算/序列/浮点/减法" ) );

FloatArraySubNode::FloatArraySubNode( const QString &node_name ) : ProcessNode( node_name ) {
	outputVarPtr = nullptr;
}
bool FloatArraySubNode::initEx( MainWidget *parent ) {
...
bool FloatArraySubNode::updateLayout( ) {
	if( ProcessNode::updateLayout( ) == false )
		return false;
	return true;
}
bool FloatArraySubNode::readyNodeRunData( ) {
	return true;
}
bool FloatArraySubNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
