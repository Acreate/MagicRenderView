...
Def_Entity_NodeTypeName_Function( IntAddNode, Node::tr( "运算/单元/整数/加法" ) );
...
bool IntAddNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
