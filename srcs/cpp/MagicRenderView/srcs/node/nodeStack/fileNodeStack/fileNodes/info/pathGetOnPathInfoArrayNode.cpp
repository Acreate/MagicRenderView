#include "pathGetOnPathInfoArrayNode.h"
...
Def_Entity_NodeTypeName_Function( PathGetOnPathInfoArrayNode, Node::tr( "路径/获取文件与目录" ) );

PathGetOnPathInfoArrayNode::PathGetOnPathInfoArrayNode( const QString &node_name ) : ProcessNode( node_name ) {
	pathSubPathOutputVarPtr = nullptr;
	dirPathOutputVarPtr = nullptr;
	filePathOutputVarPtr = nullptr;
}
bool PathGetOnPathInfoArrayNode::initEx( MainWidget *parent ) {
...
bool PathGetOnPathInfoArrayNode::updateLayout( ) {
	return ProcessNode::updateLayout( );
}

bool PathGetOnPathInfoArrayNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
