...
Def_Entity_NodeTypeName_Function( UIntArrayMulNode, Node::tr( "运算/序列/无符号整数序列/乘法" ) );
...
bool UIntArrayMulNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
