...
bool BinArrayModNode::initEx( MainWidget *parent ) {
...
bool BinArrayModNode::updateLayout( ) {
	if( ProcessNode::updateLayout( ) == false )
		return false;
	return true;
}
bool BinArrayModNode::readyNodeRunData( ) {
	return true;
}
bool BinArrayModNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
