...
Def_Entity_NodeTypeName_Function( BinArrayDivNode, Node::tr( "运算/序列/二进制/除法" ) );

BinArrayDivNode::BinArrayDivNode( const QString &node_name ) : ProcessNode( node_name ) {
	outputVarPtr = nullptr;
}
bool BinArrayDivNode::initEx( MainWidget *parent ) {
...
bool BinArrayDivNode::updateLayout( ) {
	if( ProcessNode::updateLayout( ) == false )
		return false;
	return true;
}
bool BinArrayDivNode::readyNodeRunData( ) {
	return true;
}
bool BinArrayDivNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
