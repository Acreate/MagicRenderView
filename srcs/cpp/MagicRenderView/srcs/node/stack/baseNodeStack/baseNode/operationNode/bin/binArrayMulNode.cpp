...
BinArrayMulNode::BinArrayMulNode( const QString &node_name ) : ProcessNode( node_name ) {
...
bool BinArrayMulNode::updateLayout( ) {
	if( ProcessNode::updateLayout( ) == false )
		return false;
	return true;
}
bool BinArrayMulNode::readyNodeRunData( ) {
	return true;
}
bool BinArrayMulNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
