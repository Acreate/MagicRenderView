...
ColorArrayAddNode::ColorArrayAddNode( const QString &node_name ) : ProcessNode( node_name ) {
...
bool ColorArrayAddNode::fillNodeCall( const QDateTime &ndoe_run_start_data_time, size_t current_frame ) {
