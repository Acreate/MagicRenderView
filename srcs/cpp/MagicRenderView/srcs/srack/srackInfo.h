...
public:
	...
	SrackInfo( const QString &file_source_name, const QString &call_function_name, size_t file_line ) : fileSourceName( file_source_name ), callFunctionName( call_function_name ), fileLine( file_line ) { }
...
#define Create_SrackInfo() SrackInfo( QString(__FILE__), QString(__FUNCTION__), (__LINE__) )
