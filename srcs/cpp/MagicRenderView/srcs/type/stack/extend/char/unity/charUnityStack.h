#ifndef CHARUNITYSTACK_H_H_HEAD__FILE__
#define CHARUNITYSTACK_H_H_HEAD__FILE__

#include <type/infoStack.h>

class CharUnityStack : public InfoStack {
	Q_OBJECT;
public:
	CharUnityStack( );
	~CharUnityStack( ) override;
protected:
...
#endif // CHARUNITYSTACK_H_H_HEAD__FILE__
