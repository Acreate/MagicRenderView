#ifndef COLORUNITYSTACK_H_H_HEAD__FILE__
#define COLORUNITYSTACK_H_H_HEAD__FILE__
#pragma once

#include <type/infoStack.h>

class ColorUnityStack : public InfoStack {
	Q_OBJECT;
public:
	ColorUnityStack( );
	~ColorUnityStack( ) override;
protected:
...
#endif // COLORUNITYSTACK_H_H_HEAD__FILE__
