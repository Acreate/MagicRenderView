#ifndef COLORARRAYSTACK_H_H_HEAD__FILE__
#define COLORARRAYSTACK_H_H_HEAD__FILE__


#include <type/infoStack.h>

class ColorArrayStack : public InfoStack {
	Q_OBJECT;
public:
	ColorArrayStack( );
	~ColorArrayStack( ) override;
protected:
...
#endif // COLORARRAYSTACK_H_H_HEAD__FILE__
