#ifndef IMAGEARRAYSTACK_H_H_HEAD__FILE__
#define IMAGEARRAYSTACK_H_H_HEAD__FILE__


#include <type/infoStack.h>

class ImageArrayStack : public InfoStack {
	Q_OBJECT;
public:
	ImageArrayStack( );
	~ImageArrayStack( ) override;
protected:
...
#endif // IMAGEARRAYSTACK_H_H_HEAD__FILE__
