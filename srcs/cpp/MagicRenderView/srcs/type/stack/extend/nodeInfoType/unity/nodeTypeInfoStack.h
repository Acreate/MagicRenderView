#ifndef NODETYPEINFOSTACK_H_H_HEAD__FILE__
#define NODETYPEINFOSTACK_H_H_HEAD__FILE__
#pragma once

#include <type/infoStack.h>

class NodeTypeInfoStack : public InfoStack {
	Q_OBJECT;
public:
	NodeTypeInfoStack( );
	~NodeTypeInfoStack( ) override;
protected:
	bool init( ) override;
public:
...
#endif // NODETYPEINFOSTACK_H_H_HEAD__FILE__
