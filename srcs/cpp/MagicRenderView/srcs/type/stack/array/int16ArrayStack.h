#ifndef INT16ARRAYSTACK_H_H_HEAD__FILE__
#define INT16ARRAYSTACK_H_H_HEAD__FILE__
#pragma once
#include "../../infoStack.h"

class Int16ArrayStack : public InfoStack {
	Q_OBJECT;
public:
	using t_current_type = std::vector< int16_t >;
public:
	Int16ArrayStack( );
	~Int16ArrayStack( ) override;
...
#endif // INT16ARRAYSTACK_H_H_HEAD__FILE__
