#ifndef BOOLUNITYSTACK_H_H_HEAD__FILE__
#define BOOLUNITYSTACK_H_H_HEAD__FILE__


#include <type/infoStack.h>

class BoolUnityStack : public InfoStack {
	Q_OBJECT;
public:
	BoolUnityStack( );
	~BoolUnityStack( ) override;
protected:
...
#endif // BOOLUNITYSTACK_H_H_HEAD__FILE__
