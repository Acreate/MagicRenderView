...
BoolUnityStack::~BoolUnityStack( ) {

}
bool BoolUnityStack::init( VarDirector *var_director ) {
	if( InfoStack::init( var_director ) == false )
		return false;
	Stack_Type_Name( false, bool, tr ("bool"), tr ("Bool") );
	return true;
}
BoolUnityStack::BoolUnityStack( ) {
}
...
bool BoolUnityStack::toObj( uint64_t &result_count, const uint8_t *obj_start_ptr, const size_t &obj_memory_size, void *&result_obj_ptr ) {
...
TypeEnum::Type BoolUnityStack::getType( ) {
	return TypeEnum::Type::Unity;
}
bool BoolUnityStack::toVectorData( void *obj_start_ptr, std::vector< uint8_t > &result_data ) {
