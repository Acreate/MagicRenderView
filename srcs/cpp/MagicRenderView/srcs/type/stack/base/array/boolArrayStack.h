#ifndef BOOLARRAYSTACK_H_H_HEAD__FILE__
#define BOOLARRAYSTACK_H_H_HEAD__FILE__

#include "../../../infoStack.h"

class BoolArrayStack : public InfoStack {
	Q_OBJECT;
public:
	BoolArrayStack( );
	~BoolArrayStack( ) override;
protected:
...
#endif // BOOLARRAYSTACK_H_H_HEAD__FILE__
