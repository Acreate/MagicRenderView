#ifndef ANYPTRPAIRARRAYSTACK_H_H_HEAD__FILE__
#define ANYPTRPAIRARRAYSTACK_H_H_HEAD__FILE__
#pragma once
#include "../../infoStack.h"

class AnyPtrPairArrayStack : public InfoStack {
	Q_OBJECT;
public:
	using t_current_type = std::vector< std::pair< void *, void * > >;
public:
	AnyPtrPairArrayStack( );
	~AnyPtrPairArrayStack( ) override;
...
#endif // ANYPTRPAIRARRAYSTACK_H_H_HEAD__FILE__
