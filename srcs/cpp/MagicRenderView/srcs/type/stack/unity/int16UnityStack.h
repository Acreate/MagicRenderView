#ifndef INT16UNITYSTACK_H_H_HEAD__FILE__
#define INT16UNITYSTACK_H_H_HEAD__FILE__
#pragma once
#include "../../infoStack.h"

class Int16UnityStack : public InfoStack {
	Q_OBJECT;
public:
	Int16UnityStack( );
	~Int16UnityStack( ) override;
...
#endif // INT16UNITYSTACK_H_H_HEAD__FILE__
