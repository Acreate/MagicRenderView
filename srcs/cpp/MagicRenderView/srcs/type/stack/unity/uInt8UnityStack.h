#ifndef UINT8UNITYSTACK_H_H_HEAD__FILE__
#define UINT8UNITYSTACK_H_H_HEAD__FILE__
#pragma once
#include "../../infoStack.h"

class UInt8UnityStack : public InfoStack {
	Q_OBJECT;
public:
	UInt8UnityStack( );
	~UInt8UnityStack( ) override;
...
#endif // UINT8UNITYSTACK_H_H_HEAD__FILE__
