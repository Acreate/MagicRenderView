...
void RunToTargetNodeBuilderAction::updateActionInfo( ) {
...
bool RunToTargetNodeBuilderAction::init( ApplicationMenuStack *application_menu_stack ) {
	...
	connect( builderDirector, &BuilderDirector::release_node_run_info_signal, this, &RunToTargetNodeBuilderAction::updateActionInfo );
	connect( builderDirector, &BuilderDirector::create_node_run_info_signalr, this, &RunToTargetNodeBuilderAction::updateActionInfo );
	return true;
}
